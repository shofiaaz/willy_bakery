...
<head>
    ...
    <title>Supplier Dashboard - Willy Bakery</title>
        ...
        <div class="p-6 border-b border-bread-700">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-bread-200 text-sm">Supplier Panel</p>
                </div>
            </div>
        </div>
            ...
            <ul class="space-y-2">
                <li>
                    <a href="{{ route('supplier.dashboard') }}"
                        class="flex items-center py-3 px-4 rounded-lg hover:bg-bread-700 transition-colors duration-200 {{ request()->routeIs('supplier.dashboard') ? 'active-nav' : '' }}">
                ...
                <li>
                    <a href="{{ route('supplier.purchases.index') }}"
                        class="flex items-center py-3 px-4 rounded-lg hover:bg-bread-700 transition-colors duration-200 {{ request()->routeIs('supplier.purchases.index') ? 'active-nav' : '' }}">
